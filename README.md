...
English documentation | Turkce dokumantasyon icin [README.tr.md](./README.tr.md) dosyasina goz atabilirsiniz.

![Commity Icon](icons/commity.png)

## Features

- **Smart Task Detection** - Analyzes `git diff HEAD` on your `TASKS.md` and finds every `[ ]` to `[x]` transition.
...
- **Editable** - Edit the commit message inline in the webview before committing.
...
4. Shows confirmation panel with AI provider badge:
    ...
    |                                           |
    |  [Run in Terminal] [Copy] [Regenerate]    |
    +------------------------------------------+
```
...
> Coming soon - follow the [releases](https://github.com/egemngyk/commity/releases)
...
# Package
npm run package   # -> commity-1.0.1.vsix
